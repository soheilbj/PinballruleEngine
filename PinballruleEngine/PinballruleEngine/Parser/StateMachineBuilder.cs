...
namespace PinballruleEngine.Parser
{
    public class StateMachineBuilder
    {
        ...
        public StateMachine Match(string regularExpression)
        {
            ...
            StateMachine stateMaschine = new StateMachine();
            var result = LoopMatch(regularExpressionPart, stateMaschine);
            return stateMaschine;
        }

        public bool Recognize(string text, StateMachine stateMaschine)
        {
        ...
        public StateMachine LoopMatch(RegularExpressionPart regularExpressionPart, StateMachine stateMaschine)
        {
