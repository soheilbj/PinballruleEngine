...
namespace PinballruleEngine.RuleEngine
{
    internal class ExpressionBuilder
    {
        public Expression BuildExpression<T>(Operator ruleOperator, object value, ParameterExpression parameterExpression)
        {
            ...
            var expressionTypeValue = (ExpressionType)expressionType.GetType().GetField(System.Enum.GetName(typeof(Operator), ruleOperator)).GetValue(ruleOperator);
        ...
        public Expression BuildExpression<T>(string propertyName, Operator ruleOperator, object value, ParameterExpression parameterExpression)
        {
            ...
            FieldInfo fieldInfo = expressionType.GetType().GetField(System.Enum.GetName(typeof(Operator), ruleOperator));
